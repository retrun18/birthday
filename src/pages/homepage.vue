<template>
  <div class="fullScreen back fullWidth">
    ...
    <div class="balloon"><div class="all-wrap">
      <div class="all">
        <div class="yarn"></div>
        <div class="cat-wrap">
          <div class="cat">
...
<style scoped>
  .back{
    position: absolute;
    background: -webkit-radial-gradient(#fff0f6, #ffdbea, #fea8cc); /* Safari 5.1 - 6.0 */
    background: -o-radial-gradient(#fff0f6, #ffdbea, #fea8cc); /* Opera 11.6 - 12.0 */
    background: -moz-radial-gradient(#fff0f6, #ffdbea, #fea8cc); /* Firefox 3.6 - 15 */
    background: radial-gradient(#fff0f6, #ffdbea, #fea8cc); /* 标准的语法（必须放在最后） */
  }
  .bearLeft{
    position: absolute;
    height: 40%;
